    ...
    return (
      <div>
        <span
          ...
          className="btn btn-link border-none nav-cart-add"
        >
        ...
        <div className="cart-sidebar">
          <div className="bs-canvas-header side-cart-header p-3 ">
            <div className="d-inline-block  main-cart-title font-semibold">
              {" "}
          ...
          <div className="cart-sidebar-footer">
            <div className="cart-store-details">
              ...
              <p>
                Delivery Charges{" "}
                <strong className="float-right text-danger" id="strong">
                  + &#x20B9;29.69
                </strong>
              </p>
              <h6>
            ...
            <div className="bg-white" id="check">
              <a href="/checkout">
                <button
